	...
	return (
		<div className="bg-card rounded-2xl shadow-card overflow-hidden border border-border">
			...
			{selectedNode.description && (
				<div className="flex flex-wrap sm:justify-between sm:items-center p-4 border-t border-border bg-muted/30">
					<div className="p-4">
					...
					<button
						onClick={onNext}
						className="flex w-fit m-4 items-center gap-2 px-4 py-2 rounded-lg font-medium bg-primary hover:bg-primary/90 text-primary-foreground text-sm transition-all">
						Próximo Sugerido
