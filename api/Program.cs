...
builder.Services.AddCors(options =>
{
    ...
    {
        builder.WithOrigins("https://code-clash-egn9j5v9y-rayssas-projects-160aac96.vercel.app", "https://code-clash-git-main-rayssas-projects-160aac96.vercel.app", "https://code-clash-gray.vercel.app")
               .AllowAnyMethod()
               .AllowAnyHeader()
               .AllowCredentials();
    });
